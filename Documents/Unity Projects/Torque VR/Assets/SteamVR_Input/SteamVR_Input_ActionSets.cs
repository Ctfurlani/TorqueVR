...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Pointer p_Pointer;
        ...
        public static SteamVR_Input_ActionSet_Pointer Pointer
        {
            get
            {
                return SteamVR_Actions.p_Pointer.GetCopy<SteamVR_Input_ActionSet_Pointer>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Pointer = ((SteamVR_Input_ActionSet_Pointer)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Pointer>("/actions/Pointer")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Pointer};
        }
    }
}
